jQuery(function($){
	$(document).scroll(function(){
		...
		** onScroll(element, (int)minWindowScroll, (int)maxWindowScroll); */
	...
	function onScroll(findSection, winMin, winMax){
		if(findSection && winMin && winMax){
			// Main Function
			// Once vars are passed in, the function will see what the
			// scrollTop is and calculate max and min of passed in vars.
